...
xls=f'C:\\Users\\user\\miniconda3\\envs\\Finance_Backtest\\finance_backtest\\backtest_result\\pgl_index\\test'
save_dict_xls=f'C:\\Users\\user\\miniconda3\\envs\\Finance_Backtest\\finance_backtest\\backtest_result\\pgl_index\\test\\weight_dict.xlsx'
# load pickle
...
for name,results in portfolio_optimizer_methods_results.items():
    ...
    # plot
    gp.plot_one_df(results['summary_df'],results['summary_df'].columns[-1])
    # weight_dict
