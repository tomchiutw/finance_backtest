...
for year in range(start_year,end_year,n_steps):
    # backtest_period
    backtest_start_date=datetime(year,5,1,0,0)
    ...
    # commodities=bc.CommodityList.list_commodities(category='currency_pair',exception_list=['RUBUSD','IDRUSD','SGXUSD','ZARUSD'])
